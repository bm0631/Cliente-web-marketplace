...
import "bootstrap/dist/css/bootstrap.min.css";
  ...
  /*                              my_Minted_Nfts.js                             */
  /* -------------------------------------------------------------------------- */
  /* ---------------- Pagina que lista los NFTs que has emitido --------------- */
...
export default function myNftsForsaleNow() {
 ...
 /**
   * loadNFTs
   * Funcion que recoge los datos de la red llamando a getMyMintedNfts() del un address concreto y los coloca en objetos Js
   */
